...
{
    public static class IntrTopNavigationNodes
    {
        ...
        {
            Title = "Sales Tasks",
            Url = UrlUtility.CombineUrl("~sitecollection", IntrLists.SalesTasks.CustomUrl),
            IsExternal = true
        };
        ...
        {
            Title = "Sales Events",
            Url = UrlUtility.CombineUrl("~sitecollection", IntrLists.SalesEvents.CustomUrl),
            IsExternal = true
        };
